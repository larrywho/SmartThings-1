...
def updated() {
    ...
    state.deviceAttributes << [ devices: 'temperatures', attributes: ['temperature','outdoorTemperature']]
    state.deviceAttributes << [ devices: 'thermostats', attributes: ['temperature','heatingSetpoint','coolingSetpoint','thermostatSetpoint','thermostatMode','thermostatFanMode','thermostatOperatingState','thermostatSetpointMode','scheduledSetpoint','optimisation','windowFunction','outdoorTemperature']]
...
def handleEvent(evt) {
    ...
    if (measurement == "outdoorTemperature")
    {
       measurement = "temperature"
       deviceName = escapeStringForInfluxDB("Outdoor Temperature")
    }
...
private getGroupName(id) {
    ...
    else if (id == '0fd8ef7d-7fa7-4e12-b3dd-9a94183802bc') {return 'Family Room'}
    else if (id == 'd77578a1-4c85-4553-a6b3-9c3ee0edebc5') {return 'Garage'}
    else if (id == 'f0e8ff0e-6e52-4e14-a25b-1150126dc3e7') {return 'Master Bedroom'}
    else if (id == 'f3be9253-9cc1-4c27-9942-e63a9eb9459a') {return 'Living Room'}
    else if (id == 'fa66dbcc-1781-4ae4-b2c0-3d6615ea29e7') {return 'Chin Room'}
    else {return 'Unknown'}    
}